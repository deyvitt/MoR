...
class MoRTrainingManager:
    ...
    def init(self, model: MoRTransformer, base_lr: float = 1e-4, router_lr: float = 5e-4, aux_loss_weight: float = 0.01):
        self.model = model
    ...
    def training_step(self, batch: torch.Tensor, targets: torch.Tensor, criterion: nn.Module) -> Dict[str, float]:
