...
class MoRMonitor:
    ...
    def log_routing_decision(self, layer_idx: int, decision: str, input_complexity: float):
        ...
        self.routing_history.append({'layer': layer_idx, 'decision': decision, 'complexity': input_complexity, 'timestamp': time.time()})
    ...
    def analyze_routing_patterns(self):
        ...
        return {'complexity_routing': complexity_routing, 'layer_decisions': layer_decisions}
